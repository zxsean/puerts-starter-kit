...
export function testXHR() {
	...
	UnitTest.test('请求 https://www.baidu.com', new Promise((resolve, reject) => {
	...
	UnitTest.test('ReadyState 状态', new Promise((resolve, reject) => {
		const req = new XMLHttpRequest();
	...
	UnitTest.test('请求进度', new Promise((resolve, reject) => {
		const req = new XMLHttpRequest();
	...
	UnitTest.test('HTTP 错误', new Promise((resolve, reject) => {
		const req = new XMLHttpRequest();
		req.onerror = ()=>{
	...
	UnitTest.test('application/json 解析为对象', new Promise((resolve, reject) => {
		const req = new XMLHttpRequest();
	...
	UnitTest.test('POST JSON 对象', new Promise((resolve, reject) => {
		const req = new XMLHttpRequest();
